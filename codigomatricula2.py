...
def validar_matricula(placa):
    ...
    padroes = [
        r"[A-Z]{2}[0-9]{2}[A-Z]{2}",  # AA00AA
        r"[0-9]{2}[A-Z]{2}[0-9]{2}",  # 00AA00
        r"[A-Z]{2}[0-9]{4}",         # AA0000
        r"[0-9]{4}[A-Z]{2}"          # 0000AA
    ]

    for p in padroes:
        if re.fullmatch(p, placa):
            return True
...
while True:
    ...
    # desenhar matrículas detectadas
